...
describe('UploadService E2E Test', () => {
  ...
  itif(awsAccessKey && awsSecretKey)('should upload files successfully using AWSService', async () => {
  ...
  itif(awsAccessKey && awsSecretKey)('should upload file by path successfully using AWSService', async () => {
    const awsStorageConfig = new AWSService(awsAccessKey, awsSecretKey, 'eu-central-1', 'hederatest');
    const uploadService = new UploadService(awsStorageConfig);
  ...
  itif(awsAccessKey && awsSecretKey)('should upload files by path directory successfully using AWSService', async () => {
    const awsStorageConfig = new AWSService(awsAccessKey, awsSecretKey, 'eu-central-1', 'hederatest');
    const uploadService = new UploadService(awsStorageConfig);
  ...
  itif(awsAccessKey && awsSecretKey)('should upload metadata successfully using AWSService', async () => {
    const awsStorageConfig = new AWSService(awsAccessKey, awsSecretKey, 'eu-central-1', 'hederatest');
    const uploadService = new UploadService(awsStorageConfig);
