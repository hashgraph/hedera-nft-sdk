...
import { JSON_METADATA_UNIT_TESTS_OUTPUT_METADATA_FOLDER_PATH, JSON_METADATA_UNIT_TESTS_OUTPUT_NEW_METADATA_FOLDER_PATH } from '../../__mocks__/consts';
const csvRows = [{
  name: '',
  creator: '',
  description: '',
...
describe('JsonMetadataFromCSVConverter', () => {
  describe('saveMetadataObjectsAsJsonFiles', () => {
    it('should save content of MetadataObject[] to json files', () => {
      const metadataObjectsFromCSVRows = parseCSVRowsToMetadataObjects({
      ...
      fs.mkdirSync(JSON_METADATA_UNIT_TESTS_OUTPUT_METADATA_FOLDER_PATH, {
        recursive: true
      });
    ...
    it('should create directory if path do not point to directory save content of MetadataObject[] to json files', () => {
      ...
      fs.mkdirSync(JSON_METADATA_UNIT_TESTS_OUTPUT_NEW_METADATA_FOLDER_PATH, {
        recursive: true
      });
      expect([firstJson, secondJson]).toStrictEqual(objectsFromCSVRows);
    });
