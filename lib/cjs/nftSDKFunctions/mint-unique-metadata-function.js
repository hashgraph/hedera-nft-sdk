...
var _getDataFromFile = require("../helpers/get-data-from-file");
...
const mintUniqueMetadataFunction = async _ref => {
  let {
    client,
    tokenId,
    batchSize = 5,
  ...
  const mintedNFTs = [];
  const metaData = pathToMetadataURIsFile ? await (0, _getDataFromFile.getDataFromFile)(pathToMetadataURIsFile) : metadataArray || [];
...
//# sourceMappingURL=mint-unique-metadata-function.js.map