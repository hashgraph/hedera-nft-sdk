...
exports.CREATE_TOKEN_NON_FUNGIBLE_UNIQUE_WITH_CUSTOM_FEES = exports.CREATE_TOKEN_NON_FUNGIBLE_UNIQUE = void 0;
var _feeTool = require("./fee-tool");
/*-
 *
 * Hedera NFT SDK
 *
...
const CREATE_TOKEN_NON_FUNGIBLE_UNIQUE = exports.CREATE_TOKEN_NON_FUNGIBLE_UNIQUE = {
  formulae: {
    node: {
  ...
  feeSchedules: _feeTool.FEE_SCHEDULES.CREATE_TOKEN_NON_FUNGIBLE_UNIQUE
};
const CREATE_TOKEN_NON_FUNGIBLE_UNIQUE_WITH_CUSTOM_FEES = exports.CREATE_TOKEN_NON_FUNGIBLE_UNIQUE_WITH_CUSTOM_FEES = {
  formulae: {
    node: {
  ...
  feeSchedules: _feeTool.FEE_SCHEDULES.CREATE_TOKEN_NON_FUNGIBLE_UNIQUE_WITH_CUSTOM_FEES
};
//# sourceMappingURL=fee-tool-config.js.map